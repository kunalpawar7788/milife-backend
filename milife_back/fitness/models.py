...
class Checkin(TimeStampedUUIDModel):
    ...
    waist = models.DecimalField(_("waist"), max_digits=5, decimal_places=1, default=0)
    hips = models.DecimalField(_("hips"), max_digits=5, decimal_places=1, default=0)
    chest = models.DecimalField(_("chest"), max_digits=5, decimal_places=1, default=0)
    shoulders = models.DecimalField(_("shoulders"), max_digits=5, decimal_places=1, default=0)
    left_arm = models.DecimalField(_("left_arm"), max_digits=5, decimal_places=1, default=0)
    right_arm = models.DecimalField(_("right_arm"), max_digits=5, decimal_places=1, default=0)
    left_leg = models.DecimalField(_("left_leg"), max_digits=5, decimal_places=1, default=0)
    right_leg = models.DecimalField(_("right_leg"), max_digits=5, decimal_places=1, default=0)
