"""Django settings for milife-back project.
...
APPS_DIR = ROOT_DIR.path('milife_back')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'milife_back.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'milife_back.users.auth.backends.UserTokenAuthentication',

        # Mainly used for api debug.
        'rest_framework.authentication.SessionAuthentication',
    ),
    'EXCEPTION_HANDLER': 'milife_back.base.exceptions.exception_handler',
}
...
SITE_NAME = env("SITE_NAME", default='milife-back')
...
FRONTEND_SITE_NAME = env('FRONTEND_SITE_NAME', default='milife-back')
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL',
                         default='anuvrat@anuvrat.in')
EMAIL_SUBJECT_PREFIX = env('EMAIL_SUBJECT_PREFIX', default='[milife-back] ')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'milife_back.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = 'milife_back.base.views.csrf_failure'
...
def get_release():
    ...
    import os
    import raven
    release = milife_back.__version__
    try:
